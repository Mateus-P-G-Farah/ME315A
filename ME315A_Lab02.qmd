...
1. RESPOSTA
Para determinar o percentual global de voos atrasados (Percentual = Atrasados \ Total) agrupando lotes de dados sem perda de precisão, as duas estatísticas suficientes necessárias para cada combinação de data e companhia aérea são:
